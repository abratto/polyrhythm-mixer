...
export const instrumentData = {
  ...
  bata_low_slap: {
    ...
    label: 'Batá Slap (Low)',
    params: [
      { k: 'baseFreq',      v: 225,  label: 'Base Frequency',   unit: 'Hz', lo: 80, hi: 500, step: 1, gloss: 'Matched to the Iyá enú\'s 1.5 coupling frequency (225 Hz).' },
      ...
      { k: 'bodyVol',       v: 0.50, label: 'Body Volume',      unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Less volume than the enú.' },
      { k: 'bodyDecay',     v: 0.15, label: 'Body Decay',       unit: 's',  lo: 0.02, hi: 0.4, step: 0.005, gloss: 'Very dry — the chachá does not sustain.' },
      { k: 'overRatio1',    v: 1.54, label: 'Overtone Ratio',   unit: '',   lo: 1.1, hi: 3.0, step: 0.01, gloss: 'The hourglass shell mode.' },
      { k: 'overVol1',      v: 0.35, label: 'Overtone Volume',  unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Louder than the enú — no paste to damp it.' },
      { k: 'overDecay1',    v: 0.08, label: 'Overtone Decay',   unit: 's',  lo: 0.02, hi: 0.4, step: 0.005, gloss: 'Dry skin ring.' },
      { k: 'slapFreq',      v: 4000, label: 'Slap Filter Freq', unit: 'Hz', lo: 200, hi: 8000, step: 10, gloss: 'Shifted way up from the enú — pure, bright rawhide crack.' },
      { k: 'slapQ',         v: 2.0,  label: 'Slap Q',           unit: '',   lo: 0.5, hi: 5.0, step: 0.1, gloss: 'Resonant crack.' },
      { k: 'slapVol',       v: 0.70, label: 'Slap Volume',      unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'The attack transient is the dominant feature of the chachá sound.' },
  ...
  bata_middle_slap: {
    ...
    params: [
      { k: 'baseFreq',      v: 352,  label: 'Base Frequency',   unit: 'Hz', lo: 100, hi: 700, step: 1, gloss: 'Matched to the Itótele enú\'s 1.6 coupling frequency (352 Hz).' },
      ...
      { k: 'bodyVol',       v: 0.45, label: 'Body Volume',      unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Less volume than the enú.' },
      { k: 'bodyDecay',     v: 0.12, label: 'Body Decay',       unit: 's',  lo: 0.02, hi: 0.4, step: 0.005, gloss: 'Even faster decay due to smaller diameter and higher tension.' },
      { k: 'overRatio1',    v: 1.54, label: 'Overtone Ratio',   unit: '',   lo: 1.1, hi: 3.0, step: 0.01, gloss: 'The hourglass shell mode.' },
      { k: 'overVol1',      v: 0.30, label: 'Overtone Volume',  unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Undamped skin overtone.' },
      { k: 'overDecay1',    v: 0.06, label: 'Overtone Decay',   unit: 's',  lo: 0.02, hi: 0.4, step: 0.005, gloss: 'Dry skin ring.' },
      { k: 'slapFreq',      v: 5000, label: 'Slap Filter Freq', unit: 'Hz', lo: 200, hi: 8000, step: 10, gloss: 'Sharper and more piercing than the Iyá chachá.' },
      { k: 'slapQ',         v: 2.5,  label: 'Slap Q',           unit: '',   lo: 0.5, hi: 5.0, step: 0.1, gloss: 'Higher resonance for a tighter "ping".' },
      { k: 'slapVol',       v: 0.75, label: 'Slap Volume',      unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Attack dominates.' },
      { k: 'slapDecay',     v: 0.015,label: 'Slap Decay',       unit: 's',  lo: 0.003, hi: 0.1, step: 0.001, gloss: 'Faster transient.' }
    ]
  },
  ...
  bata_high_slap: {
    ...
    params: [
      { k: 'baseFreq',      v: 600,  label: 'Base Frequency',   unit: 'Hz', lo: 200, hi: 1000, step: 1, gloss: 'Matched to the Okónkolo enú\'s perfect-octave coupling (600 Hz).' },
      ...
      { k: 'bodyVol',       v: 0.35, label: 'Body Volume',      unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'At 600 Hz human hearing is very sensitive; it needs less volume.' },
      { k: 'bodyDecay',     v: 0.08, label: 'Body Decay',       unit: 's',  lo: 0.02, hi: 0.4, step: 0.005, gloss: 'Dies almost instantly.' },
      { k: 'overRatio1',    v: 1.54, label: 'Overtone Ratio',   unit: '',   lo: 1.1, hi: 3.0, step: 0.01, gloss: 'The hourglass shell mode.' },
      { k: 'overVol1',      v: 0.25, label: 'Overtone Volume',  unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Undamped skin overtone.' },
      { k: 'overDecay1',    v: 0.04, label: 'Overtone Decay',   unit: 's',  lo: 0.02, hi: 0.4, step: 0.005, gloss: 'Dies almost immediately.' },
      { k: 'slapFreq',      v: 6500, label: 'Slap Filter Freq', unit: 'Hz', lo: 200, hi: 8000, step: 10, gloss: 'Extremely high, biting transient.' },
      { k: 'slapQ',         v: 3.0,  label: 'Slap Q',           unit: '',   lo: 0.5, hi: 5.0, step: 0.1, gloss: 'Very tight resonance.' },
      { k: 'slapVol',       v: 0.85, label: 'Slap Volume',      unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Almost entirely an attack sound.' },
      { k: 'slapDecay',     v: 0.01, label: 'Slap Decay',       unit: 's',  lo: 0.003, hi: 0.1, step: 0.001, gloss: 'Pure, microscopic snap.' }
    ]
  },
  ...
  clap: {
    ...
    label: 'Handclap',
    params: [
      { k: 'filterFreq', v: 1300, label: 'Filter Freq', unit: 'Hz', lo: 300, hi: 4000, step: 10, gloss: 'Bandpass centre.' },
      { k: 'burstVol',   v: 0.45, label: 'Burst Volume',unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Level of each of the three initial bursts.' },
      { k: 'burstDecay', v: 0.02, label: 'Burst Decay', unit: 's',  lo: 0.005, hi: 0.08, step: 0.001, gloss: 'Length of each burst.' },
      { k: 'tailVol',    v: 0.65, label: 'Tail Volume', unit: '',   lo: 0, hi: 1, step: 0.01, gloss: 'Level of the main clap.' },
      { k: 'tailDecay',  v: 0.22, label: 'Tail Decay',  unit: 's',  lo: 0.02, hi: 0.6, step: 0.005, gloss: 'Main clap length.' }
    ]
  },
